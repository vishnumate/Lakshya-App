...
import '../models/about_abc_one_item_model.dart';
import 'package:flutter/material.dart';
import 'package:lakshya/core/app_export.dart';

// ignore: must_be_immutable
class AboutAbcOneItemWidget extends StatelessWidget {
  AboutAbcOneItemWidget(this.aboutAbcOneItemModelObj);

  AboutAbcOneItemModel aboutAbcOneItemModelObj;

  var controller = Get.find<AboutAbcOneController>();
